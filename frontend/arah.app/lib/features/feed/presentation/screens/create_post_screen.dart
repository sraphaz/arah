          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                TextButton(
                  onPressed: _submitting || !hasTerritory ? null : _submit,
                  child: _submitting
                      ? SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          l10n.noTerritorySelected,
                          textAlign: TextAlign.center,
                          style: Theme.of(context).textTheme.titleMedium,
                        ),
                        const SizedBox(height: AppConstants.spacingSm),
                        Text(
                          l10n.chooseTerritoryInExplore,
                          textAlign: TextAlign.center,
                          ...
                          child: Column(
                            ...
                            children: [
                              TextFormField(
                                ...
                                maxLength: 200,
                                validator: (v) {
                                  if (v == null || v.trim().isEmpty) return l10n.informTitle;
                                  return null;
                                },
                              ),
                              ...
                              TextFormField(
                                ...
                                maxLines: 5,
                                validator: (v) {
                                  if (v == null || v.trim().isEmpty) return l10n.informContent;
                                  return null;
                                },
                              ),
                              const SizedBox(height: AppConstants.spacingLg),
                              ...
                              OutlinedButton.icon(
                                ...
                                label: Text(
                                  _selectedImagePath == null ? l10n.addImage : l10n.changeImage,
                                ),
                              ),
                              if (_selectedImagePath != null) ...[
                                const SizedBox(height: AppConstants.spacingSm),
