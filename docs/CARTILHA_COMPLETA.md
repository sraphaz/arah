...
2. [Estrutura do Time](#estrutura-do-time)
3. [Papéis e Responsabilidades](#papéis-e-responsabilidades)
4. [Fluxos de Trabalho](#fluxos-de-trabalho)
5. [Ferramentas e Recursos](#ferramentas-e-recursos)
6. [Comunicação e Colaboração](#comunicação-e-colaboração)
7. [Discord - Organização do Time](#discord---organização-do-time)
8. [GitHub - Controle de Código](#github---controle-de-código)
9. [Processo de Contribuição](#processo-de-contribuição)
10. [Valores na Prática](#valores-na-prática)
...
**Como começar**:
👉 **[Onboarding Público](./ONBOARDING_PUBLICO.md)**
...
### Fluxo de Feedback da Comunidade
...
👉 **[Guia Completo do Discord](#discord---organização-do-time)**
...
👉 **[Guia Completo do GitHub](#github---controle-de-código)**
...
- **[Onboarding Público](./ONBOARDING_PUBLICO.md)** - Entrada principal
- **[Onboarding Desenvolvedores](./ONBOARDING_DEVELOPERS.md)** - Guia para desenvolvedores
- **[Onboarding Analistas](./ONBOARDING_ANALISTAS_FUNCIONAIS.md)** - Guia para analistas
- **[Visão do Produto](./01_PRODUCT_VISION.md)** - Propósito e valores
- **[Contribuindo](./41_CONTRIBUTING.md)** - Guia geral
