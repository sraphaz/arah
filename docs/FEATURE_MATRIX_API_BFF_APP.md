...
| **Marketplace** (search, add-to-cart, checkout) | ✅ | ✅ | ✅ | App: busca, carrinho, jornada checkout PIX + QR. |
| **Marketplace V1** (cart, stores, items, pay) | ✅ | ✅ | ✅ | App: CRUD items na loja; `pay`/`confirm-payment`; `payments/enable`. |
