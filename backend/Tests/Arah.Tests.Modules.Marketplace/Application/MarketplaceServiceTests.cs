...
using Arah.Tests.Shared.TestHelpers;
using Xunit;

namespace Arah.Tests.Modules.Marketplace.Application;
...
public sealed class MarketplaceServiceTests
{
    ...
    public async Task InquiryService_ListMyAndReceivedInquiries()
    {
        ...
        await userRepository.AddAsync(
            new User(buyerId, "Comprador", "comprador@Arah.com", "123.456.789-00", null, null, null, "google", "buyer-ext", DateTime.UtcNow),
            CancellationToken.None);
