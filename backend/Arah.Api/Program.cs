...
builder.Services.Configure<Arah.Api.Configuration.ClientCredentialsOptions>(builder.Configuration.GetSection("ClientCredentials"));
...
builder.Services.AddScoped<Microsoft.AspNetCore.Authorization.IAuthorizationHandler, Arah.Api.Security.SystemAdminAuthorizationHandler>();
...
builder.Services.AddSingleton<Arah.Application.Interfaces.IDistributedCacheService>(
    serviceProvider =>
    {
