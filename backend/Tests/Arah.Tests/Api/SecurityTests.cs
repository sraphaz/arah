...
public sealed class SecurityTests
{
    ...
    public async Task RateLimiting_WriteEndpoint_Returns429AfterLimit()
    {
        ...
        await client.PostAsJsonAsync(
            ...
            new Arah.Api.Contracts.Territories.TerritorySelectionRequest(ActiveTerritoryId));
    ...
    public async Task Validation_CreateAsset_Returns400ForInvalidGeoAnchors()
    {
        ...
        var response = await client.PostAsJsonAsync(
            "api/v1/assets",
            new Arah.Api.Contracts.Assets.CreateAssetRequest(
                ActiveTerritoryId,
                "Trilha",
                "Trilha Teste",
                "Descrição",
                new[]
                {
                    new Arah.Api.Contracts.Assets.AssetGeoAnchorRequest(
    ...
    public async Task Validation_UpdateDisplayName_Returns400ForInvalidInput()
    {
        ...
        var response = await client.PutAsJsonAsync(
            ...
            new Arah.Api.Contracts.Users.UpdateDisplayNameRequest(""));
    ...
    public async Task Validation_UpdateContactInfo_Returns400ForInvalidEmail()
    {
        ...
        var response = await client.PutAsJsonAsync(
            ...
            new Arah.Api.Contracts.Users.UpdateContactInfoRequest(
    ...
    public async Task Validation_SuggestTerritory_Returns400ForInvalidCoordinates()
    {
        ...
        var response = await client.PostAsJsonAsync(
            ...
            new Arah.Api.Contracts.Territories.SuggestTerritoryRequest(
                "Território Teste",
    ...
    public async Task Authorization_CuratorCanValidateAlerts()
    {
        ...
        var response = await client.PostAsJsonAsync(
            ...
            new Arah.Api.Contracts.Alerts.ValidateAlertRequest("VALIDATED"));
    ...
    public async Task Authorization_ResidentCanCreateAssets()
    {
        ...
        var response = await client.PostAsJsonAsync(
            ...
            new Arah.Api.Contracts.Assets.CreateAssetRequest(
                ...
                "Test Asset",
                "Description",
                new List<Arah.Api.Contracts.Assets.AssetGeoAnchorRequest>
                {
                    new Arah.Api.Contracts.Assets.AssetGeoAnchorRequest(-23.37, -45.02)
                }));
    ...
    public async Task Authorization_ResourceOwnership_IsEnforced()
    {
        ...
        {
            var post = await createResponse.Content.ReadFromJsonAsync<Arah.Api.Contracts.Feed.FeedItemResponse>();
            if (post is not null)
            {
