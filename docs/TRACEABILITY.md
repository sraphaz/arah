...
| Feed posts/eventos | `docs/USER_STORIES.md` | MVP | `backend/Araponga.Api/Controllers/FeedController.cs` (CreatePost aceita GeoAnchors opcionais) | Posts exigiam GeoAnchor obrigatório. | GeoAnchors 0..N derivados de mídias; request não define anchors. |
