...
#### 23.1 Modelo de Domínio - Compra Coletiva
...
#### 23.3 Sistema de Compra Coletiva
**Estimativa**: 32 horas (4 dias)  
**Status**: ❌ Não implementado
...
#### 23.4 Sistema de Interesse de Compra
**Estimativa**: 32 horas (4 dias)  
**Status**: ❌ Não implementado
...
#### 23.5 Sistema de Agenda de Compras
**Estimativa**: 24 horas (3 dias)  
**Status**: ❌ Não implementado
...
#### 23.8 Integração com Moeda Territorial e Gamificação
**Estimativa**: 16 horas (2 dias)  
**Status**: ❌ Não implementado
...
**Depende de**: Fases 6, 14, 16, 17, 20  
