...
function Logo({
  ...
  const glyph = mark === 'png' ? /*#__PURE__*/React.createElement("img", {
    src: window.__resources && window.__resources.logo || "../../assets/arah-logo.png",
    alt: "Arah",
    style: {
      height: size,
      width: 'auto',
  ...
  content: {
    t1: {
      ...
      feed: [{
        ...
        type: 'General',
        visibility: 'Public',
        photo: window.__resources && window.__resources.cover || '../../assets/cover-rainforest.png',
